...
public class TelaBuscaProdutoAtualizar extends JFrame {

    private TelaAdmin telaAdmin;
    public TelaBuscaProdutoAtualizar(TelaAdmin telaAdmin) {
    ...
    private void buscarProduto(JTextField textId) throws IOException {
        ...
        try {
            int idProduto = Integer.parseInt(textId.getText());

            ArquivoProdutos arquivoProduto = new ArquivoProdutos();
            Produto produto = arquivoProduto.leituraProdutosId(idProduto, "Lista Produtos.CSV");
            ...
            if(produto != null){
                ...
                TelaAtualizarProduto telaAtualizarProduto = new TelaAtualizarProduto(produto, telaAdmin);
...
public static void main(String[] args) {
    SwingUtilities.invokeLater(() -> {
        ...
        TelaBuscaProdutoAtualizar telaBuscaProduto = new TelaBuscaProdutoAtualizar(telaAdmin);
