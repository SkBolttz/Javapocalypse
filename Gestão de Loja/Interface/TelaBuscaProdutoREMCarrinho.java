...
public class TelaBuscaProdutoREMCarrinho extends JFrame {

    private Cliente cliente;
    @SuppressWarnings("unused")
    private TelaPrincipal telaPrincipal;
    public TelaBuscaProdutoREMCarrinho(Cliente cliente, TelaPrincipal telaPrincipal) {
    ...
    private void buscarProduto(JTextField textId) throws IOException {
        ...
        try {
            ...
            produto = arquivoPedidos.leituraProdutosId(produto.getId(), "Pedidos_" + cliente.getNome() + ".CSV");
            ...
            if(produto != null){
                ...
                TelaRemoverItemCarrinho telaAdicionarItemCarrinho = new TelaRemoverItemCarrinho(produto, cliente, telaPrincipal);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            TelaBuscaProdutoREMCarrinho telaBuscaProduto = new TelaBuscaProdutoREMCarrinho(null, null);
