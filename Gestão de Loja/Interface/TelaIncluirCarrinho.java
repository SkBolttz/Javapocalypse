...
public class TelaIncluirCarrinho extends JFrame {
    
    private Cliente cliente;
    private TelaPrincipal telaPrincipal;
        public TelaIncluirCarrinho(Cliente cliente, TelaPrincipal telaPrincipal) {
    ...
    private void buscarProduto(JTextField textId) throws IOException {
        ...
        try {
            ...
            if (produto != null) {
                ...
                TelaAdicionarItemCarrinho telaAdicionarItemCarrinho = new TelaAdicionarItemCarrinho(produto, cliente, telaPrincipal);
            ...
            JOptionPane.showMessageDialog(this, 
                    "ID do produto deve ser um número inteiro!",
                    "Erro",
                    JOptionPane.ERROR_MESSAGE);
        }
}
